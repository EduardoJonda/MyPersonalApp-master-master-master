...
//        while (user.getUsername().equals(username)){ //si existe el username pero con password incorrecto
...
//        }
    ...
    private void Registrer(){
        startActivity(new Intent(this, Main2ActivityRegistrar.class));
        finish();
    }
